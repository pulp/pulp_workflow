...
rm -rf "pulp_workflow-client"

./gen-client.sh "../pulp_workflow/workflow-api.json" "workflow" python "pulp_workflow"

pushd pulp_workflow-client
python -m build

twine check "dist/pulp_workflow_client-"*"-py3-none-any.whl"
twine check "dist/pulp_workflow_client-"*".tar.gz"

tar cvf "../../pulp_workflow/workflow-python-client.tar" ./dist
...
# Pack the built site.
tar cvf ../../pulp_workflow/workflow-python-client-docs.tar ./site
popd
popd
